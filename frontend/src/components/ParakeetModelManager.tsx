      ...
      <div className="p-4">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            ...
            {/* Tagline */}
            <p className="ml-9 text-sm text-[var(--pt-text-secondary)]">{tagline}</p>
          </div>
          ...
          <div className="ml-4 flex items-center gap-2">
            ...
            {downloadProgress === null && isError && (
              <button
                ...
                className="bg-[var(--pt-error)] px-3 py-1.5 text-sm font-medium text-white transition-colors [border-radius:3px]"
              >
                Retry
              </button>
            )}

...
export function SummaryModelSettings({ refetchTrigger }: SummaryModelSettingsProps) {
  ...
  return (
    <div className="flex flex-col gap-4 pt-6 text-[var(--pt-text)]">
      <section className="border border-[var(--pt-border)] bg-[var(--pt-surface)] p-6 [border-radius:3px]">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="mb-2 text-lg font-medium">Automatic summary</h3>
            <p className="text-sm text-[var(--pt-text-secondary)]">Generate a summary after meeting capture stops.</p>
          </div>
      ...
      <section className="border border-[var(--pt-border)] bg-[var(--pt-surface)] p-6 [border-radius:3px]">
        <h3 className="mb-2 text-lg font-medium">Summary model</h3>
        <p className="mb-6 text-sm text-[var(--pt-text-secondary)]">

  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        <div>
          <h3 className="pt-section-title mb-1">Usage analytics</h3>
        ...
        <div className="pt-group">
          <div className="pt-row">
            <div className="flex-1">
              <div className="font-medium text-[var(--pt-text)]">Enable analytics</div>
              <p className="text-sm text-[var(--pt-text-secondary)]">
            ...
            <div className="flex items-center gap-2">
              {isProcessing && (
                <Loader2 className="w-4 h-4 animate-spin text-[var(--pt-text-secondary)]" />
              )}
              <Switch
          ...
          <div className="pt-card p-4">
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2">
                  <code className="flex-1 truncate rounded-[var(--pt-radius-xs)] border border-[var(--pt-border)] bg-[var(--pt-surface)] px-2 py-1 font-mono text-xs text-[var(--pt-text-secondary)]">
                    {userId}
                  </code>
                  <button
                    onClick={handleCopyUserId}
                    className="pt-button pt-button--secondary pt-button--sm shrink-0"
                    title="Copy User ID"
                  >
                    {isCopied ? (
                      <>
                        <Check className="w-3.5 h-3.5 text-[var(--pt-success)]" />
        ...
        <div className="flex items-start gap-2 rounded-[var(--pt-radius-sm)] border border-[var(--pt-border)] bg-[var(--pt-info-wash)] p-2">
          <Info className="mt-0.5 w-4 h-4 shrink-0 text-[var(--pt-info)]" />
          <div className="text-xs text-[var(--pt-text-secondary)]">
            ...
            <button
              ...
              className="text-[var(--pt-info)] underline hover:no-underline"
            >
              View privacy policy
            </button>
          </div>
